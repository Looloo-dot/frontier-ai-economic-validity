...
│   ├── paper.pdf paper.html      # previous single-column draft (superseded by the .tex)
...
│   ├── figA1_scree.png figA2_dendrogram.png       # appendix supplementary figures
│   └── fig_phase1_density.png                     # supplementary coverage/overlap figure
...
`https://github.com/<anonymised-for-submission>/aa-benchmark-validity` (link finalised in the appendix).
